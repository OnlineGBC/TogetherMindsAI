...
from models import db, User, ChatMessage, Exercise, RateLimitEntry, TherapySession, AuditLog, Clinician, ClientAccount, SessionParticipant, NotificationLog, CopilotCard, SessionSummary, SessionHidden, SessionRecording, SessionStateCert, CompAccess, AdminAuthCode, DiscountCode, HoursGrant, RecordAuthorisation, init_encryption, friendly_name_key
...
def api_feedback():
    ...
    # --- Build & send -------------------------------------------------------
    subject, plain_body, html_body = feedback_email.format_feedback_email({
        "rating": rating,
        "would_pay": would_pay,
        "platform": platform,
        "os": os_name,
